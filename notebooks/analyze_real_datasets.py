        ...
        for path in search_paths:
            if path.exists():
                ...
                parquet_files = list(path.glob("*.parquet")) + list(path.glob("*.pq")) + \
                               list(path.glob("**/*.parquet")) + list(path.glob("**/*.pq"))
                ...
                for file_path in all_files:
                    for dataset_type in self.dataset_types.keys():
                        ...
                        matches_filename = dataset_type.lower() in file_path.stem.lower()
                        matches_directory = dataset_type.lower() in str(file_path.parent).lower()
