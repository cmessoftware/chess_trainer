...
def upgrade() -> None:
    ...
    op.create_index("idx_game_analytics_game_id", "game_analytics", ["game_id"], unique=False)
    op.create_index("idx_game_analytics_source", "game_analytics", ["source"], unique=False)
    op.create_index(
        "idx_game_analytics_elo", "game_analytics", ["white_elo", "black_elo"], unique=False
    )
    op.create_index("idx_game_analytics_quality", "game_analytics", ["accuracy_white", "accuracy_black"], unique=False)
