...
| ID | Feature | Input | Verifiable output | Real-PGN test | Priority | Status | Comments |
|---|---|---|---|---|---|---|---|
| F07-006 | Significant loss | `eval_loss` | Trigger `EVALUATION_DROP` | Compare an obvious blunder with a stable game | P0 | ⬜ Todo | |
| F07-007 | Only move | MultiPV | Trigger `ONLY_MOVE` | Use a position with a single sufficient defense | P1 | ⬜ Todo | |
...
| F07-012 | Criticality score | Active triggers | Score and criticality level | Score all positions in one game | P0 | ⬜ Todo | |
| F07-013 | Position ranking | Game results | Top N critical positions | Compare top 5 with human review | P0 | ⬜ Todo | |

### 07.2 — Candidate generation

| ID | Feature | Input | Verifiable output | Real-PGN test | Priority | Status | Comments |
|---|---|---|---|---|---|---|---|
| F07-014 | Stockfish MultiPV | Critical FEN | Three candidates with PV and evaluation | Run on critical positions from a PGN | P0 | ⬜ Todo | |
| F07-015 | Played-move evaluation | Move and MultiPV | Rank or independent analysis | Test when the move is not in MultiPV | P0 | ⬜ Todo | |
| F07-016 | UCI/SAN conversion | Moves and board | Readable, legal notation | Validate all generated moves | P0 | ⬜ Todo | |
...
| ID | Feature | Input | Verifiable output | Real-PGN test | Priority | Status | Comments |
|---|---|---|---|---|---|---|---|
| F07-019 | Played move vs candidates | Played move and candidates | Evaluation, purpose, and consequence diffs | Test known errors from own games | P0 | ⬜ Todo | |
...
| F07-028 | Abstention | Insufficient evidence | `UNKNOWN` or `NEEDS_REVIEW` | Use an ambiguous position | P1 | ⬜ Todo | Included in first vertical slice |
...
| ID | Feature | Input | Verifiable output | Real-PGN test | Priority | Status | Comments |
|---|---|---|---|---|---|---|---|
| F07-035 | Review pack | Structured result | JSON with FEN, PGN, candidates, and evidence | Export one complete position | P0 | ⬜ Todo | |
...
- [ ] F07-012 — Initial criticality score
- [ ] F07-013 — Critical position ranking
- [ ] F07-014 — Stockfish MultiPV
- [ ] F07-015 — Played-move evaluation
- [ ] F07-016 — UCI/SAN conversion
- [ ] F07-019 — Played move vs candidates
- [ ] F07-028 — Diagnostic abstention
- [ ] F07-035 — Review pack
...
- [ ] Implement `EVALUATION_DROP`.
- [ ] Define a minimal `criticality_score`.
- [ ] Rank positions.
- [ ] Select top N.
- [ ] Compare ranking with human review.
...
- [ ] Evaluate the played move even when not in MultiPV.
- [ ] Compute objective differences.
- [ ] Compare main variations.
...
- [ ] Generate one review pack per position.
- [ ] Record human review.
...
- [ ] Generates review packs in JSON.
