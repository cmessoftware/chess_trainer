...
1. **Setup**: Run the prerequisite check script (Bash: `../scripts/bash/check-prerequisites.sh --json` or PowerShell: `../scripts/powershell/check-prerequisites.ps1 -Json`) from repo root and parse FEATURE_DIR and AVAILABLE_DOCS list. All paths must be absolute. For single quotes in args like "I'm Groot", use escape syntax: e.g 'I'\\''m Groot' (or double-quote if possible: "I'm Groot").
