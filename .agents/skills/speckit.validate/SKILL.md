...
1. **Setup**:
   - Run the prerequisite check script (Bash: `../scripts/bash/check-prerequisites.sh --json --require-tasks` or PowerShell: `../scripts/powershell/check-prerequisites.ps1 -Json -RequireTasks`)
