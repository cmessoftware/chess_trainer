...
1. **Setup**: Run the prerequisite check script (Bash: `../scripts/bash/check-prerequisites.sh --json` or PowerShell: `../scripts/powershell/check-prerequisites.ps1 -Json`) from repo root and parse FEATURE_DIR.
